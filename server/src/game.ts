/**
 * Room game state using chess domain. Serializes to/from wire format.
 */
...
import { formatSquare, parseSquare, parsePromotion, type WireGameState } from './types.js';
...
/** Find a matching legal move from fromSquare to toSquare (with optional promotion). */
